      ...
      <form novalidate @submit.prevent="onSubmit">
        <div class="form-field" :class="{ 'field-invalid': errors.username }">
          ...
          <div class="limited-field is-underline-field">
            ...
            />
            <small class="field-counter" aria-live="polite">{{ username.length }}/{{ MAX_USERNAME_LENGTH }}</small>
          </div>
          <small v-if="errors.username" class="field-error" data-testid="username-error">{{ errors.username }}</small>
        </div>
