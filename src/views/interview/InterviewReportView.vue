...
const loadError = ref('')
const hasScore = computed(() => Number.isFinite(Number(interview.report?.overallScore)))
const targetScore = computed(() => (hasScore.value ? Number(interview.report.overallScore) : 0))
