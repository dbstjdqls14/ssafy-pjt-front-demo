            ...
            <div class="iv-setup-column">
              ...
              <div class="form-field iv-loose-field" :class="{ 'field-invalid': titleError }">
                ...
                <div class="limited-field is-inline-field">
                  <input id="title" v-model="title" type="text" :maxlength="TITLE_MAX_LENGTH" placeholder="예) A사 백엔드 개발자 면접" @input="onTitleInput" />
                  <small class="field-counter">{{ title.length }}/{{ TITLE_MAX_LENGTH }}</small>
                </div>
              ...
              <div class="form-field iv-loose-field" :class="{ 'field-invalid': descriptionError }">
                ...
                <div class="limited-field">
                  ...
                  ></textarea>
                  <span class="field-counter">{{ description.length }}/{{ DESCRIPTION_MAX_LENGTH }}</span>
                </div>
