...
const PERSONA_VISUALS = {
  PRACTICAL: { img: '/interviewers/1.png', avatar: '🧑‍💼', example: '예: "이 구조를 선택한 기준과 트레이드오프를 설명해 주세요."', tone: '#4e6fc2' },
  GROWTH_COACH: { img: '/interviewers/2.png', avatar: '👩‍🏫', example: '예: "그 경험에서 본인의 강점은 무엇이었다고 생각하세요?"', tone: '#3f9d7a' },
  PRESSURE: { img: '/interviewers/3.png', avatar: '🧐', example: '예: "그 판단이 틀렸다면 어떻게 대응하시겠어요?"', tone: '#c2703f' },
}
const FALLBACK_VISUAL = { img: '/interviewers/1.png', avatar: '🧑‍💼', example: '', tone: '#4e6fc2' }
