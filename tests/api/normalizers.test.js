...
import { normalizeArchiveRecord, normalizeFolderDetail } from '../../src/api/normalizers/archive.js'
...
describe('API model normalizers', () => {
  ...
  it('keeps folder descriptions from supported detail response aliases', () => {
    expect(normalizeFolderDetail({ folderId: 3, name: '면접 폴더', folderDescription: '백엔드 면접 준비' }))
      .toMatchObject({ folderId: '3', description: '백엔드 면접 준비' })
  })
